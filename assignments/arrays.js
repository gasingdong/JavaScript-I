...
function findCar(id) {
    ...
    while (start <= end) {
        ...
        if (inventory[middle].id === id) {
            car = inventory[middle];
            //Break out of the loop since we already found the car
            break;
        }
...
//Map the array to only the car models and then sort the result
...
//Map the array to only the car years
...
//Filter the array for car years less than 2000
...
//Filter the array for car makes matching BMW or Audi
